...
<head>
    ...
    .box {
        ...
        /* 33.33% để hiển thị tối đa 3 cột trên mỗi hàng */
        margin-bottom: 20px;
    ...
    .billing-info .title {
        ...
        /* Increase font size by 10% */
        margin-bottom: 15px;
        /* Increase margin-bottom by 10% */
    }

    .billing-info .user i {
        margin-right: 7px;
        /* Increase margin-right by 10% */
    }
            ...
            <div class="billing-info">
                ...
                <form method="post">
                    <button type="submit" name="canceled" class="btn"
                        onclick="return confirm('Do you want to cancel this order')">Cancel Order</button>
                </form>
                <?php } ?>
                <?php } ?>
            </div>
