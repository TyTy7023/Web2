...
// Select orders within the specified date range
$select_orders = $conn->prepare("SELECT * FROM orders WHERE date >= ? AND date <= ?");
...
<body>
    ...
    <div class="main">
        ...
        <section class="order-container">
            <h1 class="heading">RESULT ORDERS</h1>
            ...
            if (empty($grouped_orders)) {
                echo '<p class="empty">No orders found within the specified date range</p>';
            }
            ?>
